...
describe "invoice API" do
  ...
  it "invoice_item find request: unit_price" do
    invoice_item = create(:invoice_item, unit_price: 200)
    invoice_item = create(:invoice_item, unit_price: 300)

    get "/api/v1/invoice_items/find?unit_price=2.00"
  ...
  it "invoice_item find request: UPDATED AT" do
   ...
   it "invoice_item find_all request: unit_price" do
     create(:invoice_item, unit_price: 200)
     create(:invoice_item, unit_price: 200)
     create(:invoice_item, unit_price: 300)

     get "/api/v1/invoice_items/find_all?unit_price=2.00"
